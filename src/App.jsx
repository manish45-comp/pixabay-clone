...
const App = () => {
  ...
  useEffect(() => {
    fetch(
      `https://pixabay.com/api/?key=40363683-382e42d99c0b0093ecf185a73&q=${search}&image_type=photo`
    )
      .then((response) => response.json())
      .then((data) => setValues(data.hits));
    console.log(value);
  }, [search]);
    ...
    <>
      {srcData && (
        <div className="imgPreview">
          <button className="close-btn" onClick={() => setSrcData("")}>
            <i className="fa-solid fa-xmark"></i>
          </button>
          <img src={srcData} alt="image" />
        </div>
      )}

      <div className="hero">
        <nav
          className="navbar navbar-expand-lg bg-opacity-10"
          data-bs-theme="dark"
        >
              ...
              <ul className="navbar-nav mb-2 mb-lg-0">
                <li className="nav-item dropdown">
                  ...
                  <ul className="dropdown-menu">
                    ...
                    <li>
                      <a className="dropdown-item" href="#">
                        <i className="fa-solid fa-paintbrush"></i> Illustrator
                      </a>
                    </li>
                    <li></li>
                    <li>
                      <a className="dropdown-item" href="#">
                        <i className="fa-solid fa-pen-nib"></i> Vector
                      </a>
                    </li>
                  </ul>
                </li>
                ...
                <li className="nav-item">
                  <a className="upload nav-link" href="#">
      ...
      <ResponsiveMasonry columnsCountBreakPoints={{ 350: 1, 750: 2, 900: 3 }}>
        <Masonry className="images">
          {value.map((v) => {
            return (
              <img
                onClick={() => openImage(v.webformatURL)}
                className="image"
                key={v.id}
                src={v.webformatURL}
              />
